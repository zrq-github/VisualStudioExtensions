...
namespace FirstWindow
{
    ...
    internal sealed class MyWindowCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("5c892b21-30e2-4abe-be0d-a92e8a3152f5");
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            {
                ToolWindowPane window = await this.package.ShowToolWindowAsync(typeof(MyWindow), 0, true, this.package.DisposalToken);
